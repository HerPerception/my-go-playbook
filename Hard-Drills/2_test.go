...
func TestDrill_FilterEvens(t *testing.T) {
...
func TestDrill_CheckUser(t *testing.T) {
...
func TestDrill_RemoveDuplicates(t *testing.T) {
...
func TestDrill_GroupEmployees(t *testing.T) {
	input := []Employee{
...
func TestDrill_LRUCache(t *testing.T) {
	cache := &LRUCache{}
	cache.Visit("home")
	cache.Visit("about")
	cache.Visit("contact")
...
func TestDrill_FindMinMax(t *testing.T) {
